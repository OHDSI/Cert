...
GROUP BY A.PERSON_ID, A.FIRST_DRUG_ORDDATE, A.DRUG_NAME, A.LAB_NAME, A.OBSERVATION_CONCEPT_ID, A.IS_BEFORE, A.ABNORM_TYPE, A.RANGE_LOW, A.RANGE_HIGH

-- Summary result
IF OBJECT_ID('[@target_database].[dbo].SUMMARY', 'U') IS NOT NULL
	DROP TABLE SUMMARY;
SELECT PERSON_ID, DRUG_NAME, LAB_NAME, OBSERVATION_CONCEPT_ID, ABNORM_TYPE, RANGE_LOW, RANGE_HIGH, RESULT_BEFORE=Y, RESULT_AFTER=N, RESULT AS RESULT_TYPE
...
FROM(
	SELECT *
	FROM(
		SELECT PERSON_ID, FIRST_DRUG_ORDDATE, DRUG_NAME, LAB_NAME, OBSERVATION_CONCEPT_ID, ABNORM_TYPE, RANGE_LOW, RANGE_HIGH, MAXRESULT, IS_BEFORE, 'MAX' RESULT
		FROM CERT_EXPOSURE
	...
	SELECT *
	FROM(
		SELECT PERSON_ID, FIRST_DRUG_ORDDATE, DRUG_NAME, LAB_NAME, OBSERVATION_CONCEPT_ID, ABNORM_TYPE, RANGE_LOW, RANGE_HIGH, MINRESULT, IS_BEFORE, 'MIN' RESULT
		FROM CERT_EXPOSURE
